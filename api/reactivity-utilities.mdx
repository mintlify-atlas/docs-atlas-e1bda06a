...
**Returns:** `UnwrapNestedRefs<T>` - A reactive proxy of the object, or the value as-is if not an object
...
**Returns:** `DeepReadonly<UnwrapNestedRefs<T>>` - A readonly proxy of the object, or the value as-is if not an object
